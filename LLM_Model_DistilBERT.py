...
def tokenize_function(tokenizer, texts, labels):
    logging.info("Tokenizing text data using DistilBERT tokenizer.")
...
def train_model(train_dataset, val_dataset, tokenizer, label_encoder, class_weights, model_name='distilbert-base-uncased'):
